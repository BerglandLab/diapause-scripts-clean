...
write.table(y, "/scratch/pae3g/evolution/ld_decay_dgrp_mafover0.1_revised.txt", quote=F, sep="\t", row.names = F)
...
write.table(y, "/scratch/pae3g/evolution/ld_decay_dgrp_mafless0.05_revised.txt", quote=F, sep="\t", row.names = F)