...
# m<-rbindlist(m)
# 
# write.table(m, "/scratch/pae3g/revisions/chromsome_arm_ld.txt", quote=F, sep="\t", row.names=F)
...
write.table(m, "/scratch/pae3g/revisions/interchromosomal_ld.txt", quote=F, sep="\t", row.names=F)
