...
# print(" parents")
# geno <- snpgdsOpen("/scratch/pae3g/genome-reconstruction/hs.hc.both.keep.linenames.vcf.gds", allow.fork=T)
# 
...
# y<-rbindlist(y)
# 
# write.table(y, "/scratch/pae3g/evolution/ld_decay_mafover0.1_parents_revised.txt", quote=F, sep="\t", row.names = F)
# 
# snpgdsClose(geno)
...
write.table(y, "/scratch/pae3g/evolution/ld_decay_mafless0.05_parents_revised.txt", quote=F, sep="\t", row.names = F)
