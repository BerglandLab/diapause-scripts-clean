...
write.table(m, "/scratch/pae3g/revisions/chromsome_arm_ld_parents.txt", quote=F, sep="\t", row.names=F)
...
write.table(m, "/scratch/pae3g/revisions/interchromosomal_ld_parents.txt", quote=F, sep="\t", row.names=F)
