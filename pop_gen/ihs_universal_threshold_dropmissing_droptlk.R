...
#drop tlk region
a.raw[,drop:=F]
a.raw[CHR=="X"&POSITION>3600000&POSITION<3700000, drop:=T]
a.raw<-a.raw[drop==F]
...
#     j[,test:="DGRP"]
#     #save output   
#     output=paste0("/scratch/pae3g/revisions/evolution/ihs_dgrp_universal_threshold_dropmissing_droptlk.Rdat")
#     print(output)
#     save(j, file=output)
...
#save output   
output=paste0("/scratch/pae3g/revisions/evolution/ihs_north_universal_threshold_dropmissing_droptlk.Rdat")
print(output)
save(k, file=output)
