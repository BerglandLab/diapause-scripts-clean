...
files<-fread("/scratch/pae3g/genome-reconstruction/universal_input.txt")
    ...
    j[,test:="DGRP"]
    #save output   
    output=paste0("/scratch/pae3g/revisions/evolution/ihs_dgrp_universal_threshold.Rdat")
    print(output)
    save(j, file=output)
...
#save output   
output=paste0("/scratch/pae3g/revisions/evolution/ihs_north_universal_threshold.Rdat")
print(output)
save(k, file=output)
